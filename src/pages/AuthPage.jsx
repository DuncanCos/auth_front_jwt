        ...
        <div className="space-y-4">
          ...
          <div className='flex gap-4'>
            <div>
              ...
              {password != "" ?
                <div
                  className={`mt-4 alert ${isSecure ? "alert-success" : "alert-error"
                    }`}
                >
                  {isSecure ? (
              ...
              {password != "" && confirmPassword != "" && password != confirmPassword ? 'it must be the same password' : "✔"}
              ...
              <ul className="m-4 space-y-1">
                {criteria.map((c, index) => (
                  <li key={index} className={`text-sm flex items-center`}>
                    <span
                      className={`mr-2 badge ${c.test(password) ? "badge-success" : "badge-error"
                        }`}
                    >
                      {c.test(password) ? "✔" : "✘"}
                    </span>
